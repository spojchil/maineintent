...
- 版本：1
- 日期：2026-07-12
- 关联 Issue：[#13](https://github.com/spojchil/mineintent/issues/13)
- 依赖：[领域事件与事件日志协议](./domain-events-and-journal.md)
- 依据：[ADR-0002](../adr/0002-event-driven-companion-runtime.md)、[ADR-0003](../adr/0003-separate-mind-and-action-runtime.md)
