...
> 日期：2026-07-14
>
> 对应 Issue：[#54](https://github.com/spojchil/mineintent/issues/54)
>
> 上游：[合法信息接口、Help 发现与 UI 会话](./information-access-and-ui.md)、[Information Runtime 模块设计](./information-runtime.md)、[v0.2 实施计划](../plans/v0.2-legal-information-interfaces.md)
>
> 下游：#55 状态/背包/F3、#56 HUD/聊天/Tab/当前 Screen、#57 验收矩阵
