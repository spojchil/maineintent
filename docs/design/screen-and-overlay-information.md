...
>
> 上游：[合法信息接口、Help 发现与 UI 会话](./information-access-and-ui.md)、[Information Runtime 模块设计](./information-runtime.md)、[UI Context 与界面会话模块设计](./ui-context.md)、[#63 按 Provider scopeDependencies 绑定分页 Cursor](https://github.com/spojchil/mineintent/issues/63)、[PR #66 所含普通 Read 公开 revision 后验](https://github.com/spojchil/mineintent/pull/66)
>
